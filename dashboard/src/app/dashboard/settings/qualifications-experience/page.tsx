...
import { QualificationsExperienceSettingsForm } from "@/features/settings/qualifications-experience/components/QualificationsExperienceSettingsForm";
import { getDashboardQualificationsExperienceSettings } from "@/features/settings/qualifications-experience/server";
import {
  canAccessSettingsHref,
  getSettingsRedirectHref,
} from "@/features/settings/routes";

const settingsHref = "/dashboard/settings/qualifications-experience";

export default async function SettingsQualificationsExperiencePage() {
        ...
        <section className="mx-auto grid w-full max-w-[1180px] gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[260px_minmax(0,1fr)] lg:px-8 lg:py-10">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-600 sm:text-base">
              Review certifications, transportation comfort, home environment preferences, and condition or equipment experience saved from onboarding.
            </p>

            <div className="mt-6">
              <QualificationsExperienceSettingsForm
                initialValues={qualificationsSettings.values}
                options={qualificationsSettings.options}
                canEdit={qualificationsSettings.canUpdate}
              />
            </div>
          </div>
        </section>
